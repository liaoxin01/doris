...
public:
    ...
    Status flush_async(bool bypass_packed_file = false);
...
private:
    Status _flush_memtable(bool bypass_packed_file = false);
    // push a full memtable to flush executor
    Status _flush_memtable_async(bool bypass_packed_file = false);
